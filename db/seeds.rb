...
Product.create(name: "book XS",stock: 10, price: 900, sku: "AIX0120", category: Digital.first)


Product.create(name: "Mi Mix 3",  stock: 12, price: 400, sku: "XMM0312", category: Digital.first)

Product.create(name: "ocophone",  stock: 15, price: 300, sku: "XPP0313", category: Digital.first)
